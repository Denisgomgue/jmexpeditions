...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO destinos (nombre_destino, ubicacion_destino, region_destino, provincia_destino, parque_reserva_destino, codigo_destino, id_categoria, dias_destino, descripcion_destino, altitud_destino" .
           ($foto1_name ? ", imagen1_destino" : "") .
           ($foto2_name ? ", imagen2_destino" : "") .
           ($foto3_name ? ", imagen3_destino" : "") .
           ") VALUES (:nombre, :ubicacion, :region, :provincia, :parque_reserva, :codigo, :categoria, :numero_dias, :descripcion, :altitud" .
           ($foto1_name ? ", :imagen1" : "") .
           ($foto2_name ? ", :imagen2" : "") .
           ($foto3_name ? ", :imagen3" : "") . ")";
