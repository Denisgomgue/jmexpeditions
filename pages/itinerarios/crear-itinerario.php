...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Registro de Itinerarios</h3>
                    ...
                    <div class="card-body">
                        <form action="../../app/controller/itinerarios/create.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="duracion_visita">Duración Estimada (HH:MM:SS)</label>
                                        <input type="time" class="form-control" id="duracion_visita" name="duracion_visita" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
