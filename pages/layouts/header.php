...
<html lang="es">
  <head>
    ...
    <link
    rel="icon"
    href="<?php echo $URL; ?>assets/img/kaiadmin/favicon.ico"
    type="image/x-icon"
    />
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?php echo $URL; ?>assets/img/jm_denis.jpg"
                                alt="Img Profile"
                              />
                            </div>
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?php echo $URL; ?>assets/img/chadengle.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?php echo $URL; ?>assets/img/mlane.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?php echo $URL; ?>assets/img/talha.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?php echo $URL; ?>assets/img/profile2.jpg"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="<?php echo $URL; ?>assets/img/profile.jpg"
                        alt="..."
