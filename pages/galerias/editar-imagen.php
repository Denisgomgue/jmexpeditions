                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="../../app/controller/imagenes/update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info" data-entity="destino">Actualizar </button>


                                    <a href='../../app/controller/imagenes/delete.php?id=<?php echo $imagen['id_imagen']; ?>' class='btn col btn-danger btn_eliminar' data-entity="Imagen"><i class='fa fa-trash'></i> Eliminar</a>
